import { BackOff, type LogFormat, type LogLevel, SkyWayError } from '@skyway-sdk/common';
import type model from '@skyway-sdk/model';
import type { Channel, Codec, ContentType, Encoding, Member, Publication } from '@skyway-sdk/model';
...
export declare class RtcRpcApiClient {
    ...
    publishStream({ appId, channelId, publisherId, contentType, metadata, origin, codecCapabilities, encodings, isEnabled, type, }: {
        appId: string;
        channelId: string;
        publisherId: string;
