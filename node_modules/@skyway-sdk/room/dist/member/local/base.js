...
class LocalRoomMemberBase extends member_1.RoomMemberImpl {
    ...
    constructor(member, room) {
        ...
        this.onStreamPublished = new common_2.Event();
        this.onStreamUnpublished = new common_2.Event();
        this.onPublicationListChanged = new common_2.Event();
        this.onPublicationSubscribed = new common_2.Event();
        this.onPublicationUnsubscribed = new common_2.Event();
        this.onSubscriptionListChanged = new common_2.Event();
