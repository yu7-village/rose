...
/**@internal */
class LocalSFURoomMemberImpl extends base_1.LocalRoomMemberBase {
    /**@private */
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (options.type && options.type !== 'sfu') {
                throw (0, util_1.createError)({
                    ...
                    room: this.room,
                    info: errors_1.errors.invalidPublicationTypeForSFURoom,
                    path: log.prefix,
                });
            }
            const roomPublication = yield this._publishAsSFU(stream, options).catch((errorInfo) => {
                throw (0, util_1.createError)({
                    operationName: 'LocalSFURoomMemberImpl.publish',
                    context: this._context,
                    room: this.room,
    ...
    unpublish(target) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._unpublishAsSFU(target).catch((e) => {
