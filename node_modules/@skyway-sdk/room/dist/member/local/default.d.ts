...
import type { LocalPerson, LocalPersonAdapter, LocalStream, RemoteAudioStream, RemoteDataStream, RemoteVideoStream, SubscriptionOptions } from '@skyway-sdk/core';
...
export interface LocalRoomMember extends RoomMember {
     ...
     */
    publish: <T extends LocalStream = LocalStream>(stream: T, options?: RoomPublicationOptions) => Promise<RoomPublication<T>>;
    /**
...
/**@internal */
export declare class LocalRoomMemberImpl extends LocalRoomMemberBase implements LocalRoomMember {
    /**@private */
    constructor(member: LocalPersonAdapter, room: RoomImpl);
    /**
     * @description [japanese] Room上でStreamをPublishする
     */
    publish<T extends LocalStream = LocalStream>(stream: LocalStream, options?: RoomPublicationOptions): Promise<RoomPublication<T>>;
    /**
