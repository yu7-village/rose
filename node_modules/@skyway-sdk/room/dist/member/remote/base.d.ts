...
import { Member, RemoteAudioStream, RemoteDataStream, RemoteVideoStream } from '@skyway-sdk/core';
...
export declare class RemoteRoomMemberImpl extends RoomMemberImpl implements RemoteRoomMember {
    ...
    subscribe: <T extends RemoteVideoStream | RemoteAudioStream | RemoteDataStream>(publicationId: string) => Promise<{
