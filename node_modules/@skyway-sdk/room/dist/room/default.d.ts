...
import type { LocalPersonAdapter, LocalStream, Publication, PublicationImpl, RemoteStream, SkyWayChannelImpl, SkyWayContext, SubscriptionImpl } from '@skyway-sdk/core';
...
/**@internal */
export declare class RoomImpl extends RoomBase implements Room {
    readonly _plugin?: SFUBotPlugin | undefined;
    protected _disableSignaling: boolean;
    static Create(context: SkyWayContext, channel: SkyWayChannelImpl): Promise<RoomImpl>;
    localRoomMember?: LocalRoomMember;
    private constructor();
    protected _getTargetPublication(publicationId: string, publicationType: PublicationType): RoomPublication<LocalStream> | undefined;
    protected _createLocalRoomMember<T extends LocalRoomMemberImpl>(local: LocalPersonAdapter, room: this): T;
