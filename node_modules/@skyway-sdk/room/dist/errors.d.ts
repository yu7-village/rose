export declare const roomErrors: {
    ...
    readonly sfuPublicationNotSupportDataStream: {
        readonly name: "sfuPublicationNotSupportDataStream";
        readonly detail: "RoomでPublicationのtypeを\"sfu\"に設定したり、SFURoomを使用したりする場合、DataStreamを使うことは出来ません";
        readonly solution: "Roomを使用して、DataStreamのpublishのoptions.typeに\"p2p\"を指定してください";
    };
    ...
    readonly invalidPublicationTypeForP2PRoom: {
        readonly name: "invalidPublicationTypeForP2PRoom";
        readonly detail: "P2PRoomでSFUのPublicationをpublishすることは出来ません";
        readonly solution: "publishのoptions.typeに\"p2p\"を指定してください";
    };
    readonly invalidPublicationTypeForSFURoom: {
        readonly name: "invalidPublicationTypeForSFURoom";
        readonly detail: "SFURoomでP2PのPublicationをpublishすることは出来ません";
        readonly solution: "publishのoptions.typeに\"sfu\"を指定してください";
    };
};
export declare const errors: {
    ...
    readonly connectRtcApiFailed: {
        ...
        readonly solution: "インターネットへ接続できているか、もしくはTokenのパラメータが正しいかを確かめてください";
    };
    ...
    readonly dataChannelSendError: {
        readonly name: "dataChannelSendError";
        readonly detail: "データ送信に失敗しました";
        readonly solution: "接続が閉じられている、バッファに空き容量が無い、データサイズが大きすぎる等の理由で送信に失敗しています。再度publish もしくは 送信するデータを分割してください";
    };
    readonly dataChannelGeneralError: {
        readonly name: "dataChannelGeneralError";
        readonly detail: "DataStreamの内部でエラーが発生しました";
        readonly solution: "DataStreamを作り直して再度publishしてください";
    };
};
