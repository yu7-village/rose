...
import type { Codec, ContentType, EncodingParameters, LocalAudioStream, LocalCustomVideoStream, LocalStream, LocalVideoStream, Publication, PublicationState, ReplaceStreamOptions, TransportConnectionState, WebRTCStats } from '@skyway-sdk/core';
...
import type { StreamSubscribedEvent, StreamUnsubscribedEvent } from '../room/event';
...
export declare class RoomPublicationImpl<StreamType extends LocalStream = LocalStream> implements RoomPublication {
    ...
    constructor(_publication: Publication, _room: Room);
    private _setEvents;
