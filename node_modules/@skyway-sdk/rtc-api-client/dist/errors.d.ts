export declare const errors: {
    ...
    readonly projectUsageLimitExceeded: {
        readonly name: "projectUsageLimitExceeded";
        readonly detail: "フリープランプロジェクトのリソース利用上限に達しています";
        readonly solution: "エンタープライズプランにアップグレードしてください";
    };
    readonly invalidAuthToken: {
        readonly name: "invalidAuthToken";
        readonly detail: "AuthTokenが無効です";
        readonly solution: "適切なAuthTokenを使用してください";
    };
    ...
    readonly invalidPublicationType: {
        readonly name: "invalidPublicationType";
        readonly detail: "Publicationのtypeが正しくありません";
        readonly solution: "typeを正しい値に設定してください。 \"p2p\" または \"sfu\" のいずれかを指定できます。";
    };
    ...
    readonly websocketConnectionFailure: {
        ...
        readonly solution: "ネットワーク接続状況およびフリープランをご利用の場合はリソース利用量を確認してください";
    };
    ...
    readonly failedToConnectRtcAPI: {
        ...
        readonly solution: "インターネット接続状況とTokenの内容が正しいか、またフリープランをご利用の場合はリソース利用量を確かめてください";
    };
