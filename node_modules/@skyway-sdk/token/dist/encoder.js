        ...
        switch (this.version) {
            ...
            case 2: {
                ...
                const channelScope = channelsScope.find((c) => {
                    return (0, util_1.matchScopeIdentifier)(channel, c, this.version);
                });
                if (!channelScope) {
                    return false;
                }
                ...
                return sfuBotsScope.some((sfuBotScope) => {
                    return (sfuBotScope.actions.includes('create') ||
            ...
            case 3: {
                ...
                const roomScope = roomsScope.find((r) => {
                    return (0, util_1.matchScopeIdentifier)(channel, r, this.version);
                });
                if (!roomScope) {
                    return false;
                }
                ...
                return (_a = roomScope.sfu.enabled) !== null && _a !== void 0 ? _a : true;
            }
            default:
                throw new common_1.SkyWayError({
                    path: log.prefix,
