...
class LocalPersonImpl extends member_1.MemberImpl {
    ...
    publish(stream, options = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_c = init.codecCapabilities) === null || _c === void 0 ? void 0 : _c.length) {
                publication.setCodecCapabilities(init.codecCapabilities);
            }
            if ((_d = init.encodings) === null || _d === void 0 ? void 0 : _d.length) {
            ...
            if (['video', 'audio'].includes(publication.contentType) &&
                ...
                const encodings = (_e = init.encodings) !== null && _e !== void 0 ? _e : [];
    ...
    dispose() {
        ...
        this._getRemoteMemberConnections().forEach((c) => c.close({ reason: 'localPerson disposed' }));
