...
class PublicationImpl {
    constructor(args) {
        ...
        this.updateMetadata = (metadata) => new Promise((r, f) => {
        ...
        this.disable = () => new Promise((r, f) => {
            ...
            const executeDisable = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.enable = () => new Promise((r, f) => {
            ...
            const executeEnable = () => __awaiter(this, void 0, void 0, function* () {
...
const sortEncodingParameters = (encodings) => {
    ...
    if (encode.maxBitrate) {
        // 小から大
        return encodings.sort((a, b) => { var _a, _b; return ((_a = a.maxBitrate) !== null && _a !== void 0 ? _a : 0) - ((_b = b.maxBitrate) !== null && _b !== void 0 ? _b : 0); });
    }
    else if (encode.scaleResolutionDownBy) {
        //大から小
        return encodings.sort((a, b) => { var _a, _b; return ((_a = b.scaleResolutionDownBy) !== null && _a !== void 0 ? _a : 0) - ((_b = a.scaleResolutionDownBy) !== null && _b !== void 0 ? _b : 0); });
    }
    else if (encode.maxFramerate) {
        // 小から大
        return encodings.sort((a, b) => { var _a, _b; return ((_a = a.maxFramerate) !== null && _a !== void 0 ? _a : 0) - ((_b = b.maxFramerate) !== null && _b !== void 0 ? _b : 0); });
    }
    return encodings;
};
